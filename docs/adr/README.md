...
| [ADR-003](./003-transport-abstraction.md)                | Transport Abstraction                                     | Accepted (amended: CDP and injector implemented; canIntercept consumed by ADR-016, canControlClock by ADR-017) |
