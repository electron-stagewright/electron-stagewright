/**
 * Shared test doubles for the transport layer. A `FakeSession` / `FakeTransport` pair
...
import type {
  ...
  WindowDescriptor,
  WindowRef,
} from '../../core/src/transports/index.js'
...
export class FakeTransport implements ITransport {
  ...
  constructor(opts: FakeTransportOptions = {}) {
    ...
    this.capabilities = opts.capabilities ?? fullCapabilities()
